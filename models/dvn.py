    ...
    def __init__(self, n_dim, n_layers, learn_embs, layer_AGG_w_MLP, Q_mode, Q_act, reward_calculator, environment, scalable=False):
        ...
        for emb_mode in opt.emb_mode_list:
            if emb_mode == 'gs':
                ...
                self.MLP_abds_small, self.MLP_abds_big, self.MLP_abd_big = self.get_MLP_bds(n_dim, dim_big_list, dim_interact_out)
                ...
                self.MLP_ubds_small, self.MLP_ubds_big, self.MLP_ubd_big = self.get_MLP_bds(n_dim, dim_big_list, dim_interact_out)
                ...
                self.MLP_bbds_small, self.MLP_bbds_big, self.MLP_bbd_big = self.get_MLP_bds(n_dim, dim_big_list, dim_interact_out)
